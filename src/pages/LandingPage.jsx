    ...
    <>
      ...
      <div className="min-h-screen bg-[#02010A] text-white overflow-x-hidden">
        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-lg border-b border-white/10">
          <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-20">
            <div className="flex items-center gap-3">
              <img src="/icon.png" alt="Solid Security" className="h-10 w-10 drop-shadow" />
              <div>
        ...
        <main className="pt-28">
          <section className="min-h-[78vh] flex items-center justify-center text-center px-6">
            ...
            >
              <motion.img
                variants={fadeUp}
                src="/logo.svg"
                alt="Solid Security Logo"
                className="mx-auto h-28 w-28 mb-6 drop-shadow-2xl"
              />
          ...
          <section ref={aboutRef} className="py-24 px-6 md:px-12">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="max-w-5xl mx-auto text-center">
              ...
              <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 rounded-2xl bg-white/4 border border-white/6 backdrop-blur">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <motion.div initial="hidden" whileInView="visible" variants={container} className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <motion.div key={i} variants={fadeUp} className="p-6 rounded-2xl bg-white/3 border border-white/8 backdrop-blur hover:translate-y-[-6px] transition-transform">
          ...
          {/* DASHBOARD PREVIEW */}
          <section ref={dashboardRef} className="py-24 px-6 md:px-12 bg-gradient-to-b from-black/0 to-black/70">
            <motion.div initial="hidden" whileInView="visible" variants={fadeUp} className="max-w-6xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold">Your Security Hub — Real tools, real protection</h2>
              <p className="mt-4 text-gray-300 max-w-3xl mx-auto">All core utilities live inside a single dashboard — fast scans, risk indexes, watchlists, and incident reporting. Built for operators, auditors, and everyday users.</p>

              <motion.img initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} src="/dashboard-preview.png" alt="dashboard preview" className="w-full max-w-5xl rounded-3xl mt-8 shadow-[0_30px_80px_rgba(124,58,237,0.12)]" />

              <div className="mt-8">
                <Link to="/dashboard">
                  <Button className="bg-[#14F195] text-black px-8 py-4 rounded-2xl font-semibold hover:scale-[1.02] transition">Open Dashboard</Button>
                </Link>
              </div>
            </motion.div>
          </section>
            ...
            <motion.div initial="hidden" whileInView="visible" variants={fadeUp} className="max-w-4xl mx-auto text-center bg-white/3 border border-white/6 rounded-3xl p-10 backdrop-blur">
              ...
              <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="https://t.me/SolidSecurity" target="_blank" rel="noreferrer">
                  <Button variant="outline" className="border-[#14F195]/30 text-[#14F195] px-6 py-3 rounded-2xl">Join Telegram</Button>
                </a>
              </div>
            </motion.div>
          </section>
          ...
          <footer className="py-10 px-6 md:px-12 border-t border-white/8 text-gray-400">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-6 text-sm">
                <a href="#" className="hover:text-[#14F195]">Docs</a>
                <a href="#" className="hover:text-[#14F195]">Audit</a>
                <a href="#" className="hover:text-[#14F195]">Twitter</a>
                <a href="#" className="hover:text-[#14F195]">Telegram</a>
                <a href="#" className="hover:text-[#14F195]">GitHub</a>
              </div>
            </div>
          </footer>
        </main>
